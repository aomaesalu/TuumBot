...
namespace rtx {
  ...
  {
    goals = new Goal*[2];
    //goals[0] = new Goal(BLUE_GOAL_POSITION_X, BLUE_GOAL_POSITION_Y, Vision::BLUE_GOAL);
    // TODO: Add goal color information
    //goals[1] = new Goal(YELLOW_GOAL_POSITION_X, YELLOW_GOAL_POSITION_Y, Vision::YELLOW_GOAL);
    // TODO: Add goal color information
  }
