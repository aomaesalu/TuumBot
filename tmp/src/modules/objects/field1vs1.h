...
public:
  ...
  Field1vs1(RobotSelf*, const double& = FIELD_WIDTH, const double& = FIELD_LENGTH);
  Field1vs1(Goal*, Goal*, RobotSelf*, const double& = FIELD_WIDTH, const double& = FIELD_LENGTH);
  Field1vs1(RobotSelf*, const std::vector<Ball*>&, const double& = FIELD_WIDTH, const double& = FIELD_LENGTH);
